  ...
  <main class="max-w-4xl mx-auto px-4 py-6">
    ...
    >
      ...
      <div class="mt-6 flex flex-wrap gap-3">
        ...
        <button
          class="px-4 py-2 bg-gray-100 undefined text-gray-700 undefined border border-gray-300 undefined rounded-lg font-medium hover:bg-gray-200 undefined transition-colors"
          on:click={clearForm}
        >
          Clear
        </button>
